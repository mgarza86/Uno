...
class SettingsScene(pyghelpers.Scene):
    def __init__(self, window):
        ...
        self.title = pygwidgets.DisplayText(window, (345, 150), "Difficulty", fontSize=40, textColor="white")
        ...
        # SFX toggle button
        self.sfx_title = pygwidgets.DisplayText(window, (325, 290), "SFX Volume", fontSize=40, textColor="white")
        self.sfx_on = True
        ...
        # Music toggle button
        self.music_title = pygwidgets.DisplayText(window, (310, 430), "Music Volume", fontSize=40, textColor="white")
        self.music_on = True
    ...
    def toggle_sfx_button(self):
        ...
        self.sfx_toggle = pygwidgets.TextButton(self.window, (300, 340), new_label, width=200, height=40)
        
    def toggle_music_button(self):
        # toggles the state and updates the button label
        self.music_on = not self.music_on
        new_label = "Music: " + ("On" if self.music_on else "Off")
        self.music_toggle = pygwidgets.TextButton(self.window, (300, 480), new_label, width=200, height=40)
